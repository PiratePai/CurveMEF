...
clc;
clear all;
A_dir = "low_img_dir_path"; % 包含所有源图像A的文件夹路径
B_dir = "high_img_dir_path"; % 包含所有源图像B的文件夹路径
Fused_dir = fullfile('fused_y_dir_path'); % 融合图像的Y通道的文件夹路径
save_dir = fullfile('save_path'); % 彩色融合图像的文件夹路径
